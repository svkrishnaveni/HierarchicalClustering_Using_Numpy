#!/usr/bin/env python
'''
This script applies hierarchical clustering implementation with single linkage to the data.
...
c = [2, 4, 6, 8]
for c in c:
    clusters, unique_val = hierarchical_clustering(features, "single", c)
    ...
    print('Accuracy for hierarchical clustering of single linkage  with ' + str(c) + ' clusters is ' + str(accuracy))